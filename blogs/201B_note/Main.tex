...
\usepackage{xparse}
\usepackage{etoolbox}
% Allow grabbing environment body for conditional display
\usepackage{environ}
...
\newtcolorbox{db}[1][]{
  ...
  title={Definition\ifstrempty{#1}{}{\ \textit{#1}}},
  fonttitle=\bfseries,
  boxrule=0.8pt,
  arc=4pt,
  left=2pt,
...
\newtcolorbox{eb}[1][]{
  ...
  title={Example\ifstrempty{#1}{}{\ \textit{#1}}},
  fonttitle=\bfseries,
  boxrule=0.8pt,
  arc=4pt,
  left=2pt,
...
\newtcolorbox{tb}[1][]{
  ...
  title={Theorem\ifstrempty{#1}{}{\ \textit{#1}}},
  fonttitle=\bfseries,
  boxrule=0.8pt,
  arc=4pt,
  left=2pt,
...
\newtcolorbox{lb}[1][]{
  ...
  title={Lemma\ifstrempty{#1}{}{\ \textit{#1}}},
  fonttitle=\bfseries,
  boxrule=0.8pt,
  arc=4pt,
  left=2pt,
...
% --------------------- Solution environment (show/hide) ---------------------
% Toggle: by default solutions are hidden. To show solutions, put \ShowSolutions
% in your document preamble (before \begin{document}).
\newif\ifshowsolutions
\showsolutionsfalse % default: hide solutions; change to \showsolutionstrue to show
\newcommand{\ShowSolutions}{\showsolutionstrue}
\newcommand{\HideSolutions}{\showsolutionsfalse}


% The solution environment: when \showsolutionstrue, the body is shown inside a box;
% otherwise the environment is ignored (no output).
...
% Slightly reduce the default title font size from \LARGE to \Large
\makeatletter
...
\fancyhead[L]{\hyperref[sec:contents]{\small Zhan}}
...
\title{Introduction to Statistics at an Advanced Level  \\[1em]
\normalsize STAT 201B}

% --- Author and date of last update ---

\author{\normalsize Shizhe Zhang\\[0.3em]
\small\href{mailto:shizhe\_zhang@berkeley.edu}{shizhe\_zhang@berkeley.edu}}
